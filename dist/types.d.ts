...
export type SensorExportMode = "centerArrayGrid" | "fullArrayGrid";
export type SensorBoundsMode = "autoInfer" | "manual";
export type VerticalExtentMode = "groundToModuleUnderside" | "customHeight";
export type SensorNormalMode = "upward";
export type FullArrayTilingStrategy = "rowPairBayTiling" | "rowPairSingleVolume";

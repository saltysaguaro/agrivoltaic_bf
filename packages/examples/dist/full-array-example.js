import { buildExportPackageRequest, buildFullArrayGridConfig, buildSceneExportBundle, } from "@agrivoltaic/three-exporter";
import { buildTaggedFixedTiltScene } from "./minimal-fixed-tilt.js";
export function buildFullArrayExampleRequest() {
    const scene = buildTaggedFixedTiltScene();
    const sceneExport = buildSceneExportBundle(scene, {
        sceneId: "full-array-example",
        geometrySourceMode: "visualMesh",
    });
    return buildExportPackageRequest({
        sceneExport,
        sensorConfig: buildFullArrayGridConfig({
        ...
        packageLabel: "full-array-example",
    });
}

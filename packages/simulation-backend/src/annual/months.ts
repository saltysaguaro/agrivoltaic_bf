...
export function expandMonthRange(startMonth: number, endMonth: number): number[] {
...
export function sumSelectedMonths(values: readonly number[], months: readonly number[]): number {

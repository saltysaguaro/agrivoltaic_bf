...
export const sensorGridConfigSchema = z.object({
  mode: z.enum(["centerArrayGrid", "centralRowGrid", "fullArrayGrid"]).default(DEFAULT_SENSOR_CONFIG.mode),
  ...
  verticalExtentMode: z.enum(["groundToModuleUnderside", "groundToArrayTop", "customHeight"]).default(DEFAULT_SENSOR_CONFIG.verticalExtentMode),
  ...
  fullArrayTilingStrategy: z.enum(["rowPairBayTiling", "rowPairSingleVolume", "uniformArrayGrid"]).default(DEFAULT_SENSOR_CONFIG.fullArrayTilingStrategy ?? "rowPairBayTiling"),
...
export const sensorGridVolumeSchema = z.object({
  gridId: z.string(),
  mode: z.enum(["centerArrayGrid", "centralRowGrid", "fullArrayGrid"]),
  arrayId: z.string(),
  rowPairId: z.string(),
  bayId: z.string().optional(),
...
export const fullArrayAnalysisSchema = z.object({
  ...
  tilingStrategy: z.enum(["rowPairBayTiling", "rowPairSingleVolume", "uniformArrayGrid"]),
});

...
export const DEFAULT_ANNUAL_SIMULATION_QUALITY_PRESET: AnnualSimulationQualityPreset = "medium";

export const ANNUAL_SIMULATION_QUALITY_PRESETS: Record<
AnnualSimulationQualityPreset,
AnnualSimulationQualityPresetDefinition
> = {
  low: {
    label: "Low",
...
export function resolveAnnualSimulationQualityPreset(
  preset: AnnualSimulationQualityPreset | null | undefined,
): AnnualSimulationQualityPreset {
...
export function simulationOptionsForAnnualQualityPreset(
  preset: AnnualSimulationQualityPreset | null | undefined,

import type { ExportPackageResult, SceneExportBundle, SensorExportMode, SensorGridConfig, SkyRequest } from "./types.js";
...
export type AnnualJobPhase = "queued" | "preparing_geometry" | "acquiring_weather" | "generating_tracker_states" | "building_scene" | "running_simulation" | "post_processing" | "completed" | "failed";
export type AnnualMetric = "annualIrradiance" | "percentGHI" | "shadeFraction" | "estimatedPAR";
